...
const pros::motor_gearset_e_t FLY_MAIN_GEAR = pros::E_MOTOR_GEARSET_06;
const pros::motor_gearset_e_t FLY_IND_GEAR = pros::E_MOTOR_GEARSET_06;

const bool FLY_MAIN_REVERSE = false;
const bool FLY_IND_REVERSE = false;

Flywheel::Flywheel() : flyMain(FLY_MAIN_PORT, FLY_MAIN_GEAR, FLY_MAIN_REVERSE),
